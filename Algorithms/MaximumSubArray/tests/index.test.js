...
import {findMaximumSubArrayInLinearTime} from "../linearTime";
...
describe("Maximum subArray" , () =>{
    ...
    describe('Linear time algorithm', () => {
        it('should return correct results - 1',  () => {
            expect(findMaximumSubArrayInLinearTime([1, -3, 4, 2, -4, 5])).toEqual({maxLeft: 2, maxRight: 5, sum: 7});
        })
        it('should return correct results - 2',  () => {
            expect(findMaximumSubArrayInLinearTime([1, -3, 4, 2, -4, -5])).toEqual({maxLeft: 2, maxRight: 3, sum: 6});
        })
        it('should return correct results when all numbers are negative - 1',  () => {
            expect(findMaximumSubArrayInLinearTime([-1, -3, -4, -2, -4, -5])).toEqual({maxLeft: 0, maxRight: 0, sum: -1});
        })
        it('should return correct results when all numbers are negative - 2',  () => {
            expect(findMaximumSubArrayInLinearTime([-11, -3, -4, -1, -4, -5])).toEqual({maxLeft: 3, maxRight: 3, sum: -1});
        })
    })
